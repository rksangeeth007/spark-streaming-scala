...
object StructuredStreaming {
  ...
  def main(args: Array[String]) {
    ...
    //      .config("spark.sql.warehouse.dir", "/Users/s0h0902/BigDataFinal/Repos/spark_sql_dir")
    ...
    // (instead of "append").
    val query = windowed.writeStream.outputMode("complete").option("spark.sql.streaming.checkpointLocation", "/Users/s0h0902/BigDataFinal/Repos/spark_streaming_checkpoint").format("console").start()
